      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-blue-100">
        ...
        <div className="absolute top-8 left-8">
          <div className="flex items-center mb-2">
            <div className="w-3 h-3 rounded-full bg-tracking-blue mr-2"></div>
            <span className="text-xs">Pickup Point</span>
          </div>
          <div className="flex items-center mb-2">
            <div className="w-3 h-3 rounded-full bg-tracking-green mr-2"></div>
            <span className="text-xs">Delivery Point</span>
          </div>
          <div className="flex items-center">
            <div className="w-3 h-3 rounded-full bg-tracking-orange mr-2"></div>
            <span className="text-xs">Driver Location</span>
          </div>
        </div>
        
        {/* Sample points (for demo purposes) */}
        <div className="absolute top-1/4 left-1/4 w-4 h-4 rounded-full bg-tracking-blue"></div>
        <div className="absolute bottom-1/4 right-1/4 w-4 h-4 rounded-full bg-tracking-green"></div>
        {driverLocation && (
          <div className="absolute top-1/2 left-1/2 w-4 h-4 rounded-full bg-tracking-orange animate-pulse"></div>
        )}
  ...
  return (
    <Card className="overflow-hidden border border-border animate-fade-in">
      <div className="p-4 border-b">
        <h3 className="text-lg font-semibold">Tracking Map</h3>
      </div>
        ...
        <div className="p-4 border-t flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
          <div className="flex items-center">
            <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center mr-3">
              <UserIcon className="w-5 h-5 text-tracking-blue" />
            </div>
            <div>
              <p className="font-medium">{driver.name}</p>
              <p className="text-sm text-muted-foreground">{driver.vehicleInfo}</p>
            </div>
          </div>
          ...
          <Button 
            ...
            className="bg-tracking-green hover:bg-tracking-green/90"
          >
